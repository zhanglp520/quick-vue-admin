...
import { generator as api } from "./index";
export { downloadFileStream } from "@/api/common";

export const connect = (data: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/connect`,
        method: "POST",
        data
    });
};
...
export const getTables = (params: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/getTables`,
        method: "GET",
        params
    });
};
export const getFileds = (params: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/getFileds`,
        method: "GET",
        params
    });
};
export const getEntity = (params: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/getEntity`,
        method: "GET",
        params
    });
};
export const getVo = (params: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/getVo`,
        method: "GET",
        params
    });
};
export const getDto = (params: any) => {
    return request<IQuickResponseData<Array<IUser>>>({
        url: `/develop/api/develop/generators/getDto`,
        method: "GET",
        params
    });
};
